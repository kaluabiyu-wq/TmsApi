...
[
    ("STU-0001", "Alice Smith", 3.8m, true),
    ("STU-0002", "Bob Jones", 2.9m, true),
    ("STU-0003", "Charlie Brown", 3.4m, false),
    ("STU-0004", "Diana Prince", 3.9m, true),
    ("STU-0005", "Evan Wright", 2.5m, true),
    ("STU-0006", "Abebe Kebede", 3.6m, true),
    ("STU-0007", "Tigist Alemu", 3.9m, true),
    ("STU-0008", "Dawit Mekonnen", 2.7m, true),
    ("STU-0009", "Hiwot Girma", 3.2m, false),
    ("STU-0010", "Yohannes Tesfaye", 3.5m, true),
    ("STU-0011", "Selamawit Bekele", 3.8m, true),
    ("STU-0012", "Bereket Haile", 2.6m, true),
    ("STU-0013", "Meron Assefa", 3.4m, true),
    ("STU-0014", "Nahom Wolde", 2.9m, false),
    ("STU-0015", "Rahel Tadesse", 3.7m, true),
    ("STU-0016", "Kaleb Fikru", 3.1m, true),
    ("STU-0017", "Eden Solomon", 3.9m, true),
    ("STU-0018", "Mikiyas Getachew", 2.8m, true),
    ("STU-0019", "Bethlehem Yilma", 3.3m, false),
    ("STU-0020", "Elias Demeke", 3.0m, true),
    ("STU-0021", "Sara Abera", 3.6m, true),
    ("STU-0022", "Yared Negash", 2.5m, true),
    ("STU-0023", "Feven Teshome", 3.8m, true),
    ("STU-0024", "Samuel Desta", 3.2m, false),
    ("STU-0025", "Lidya Worku", 3.5m, true),
    ("STU-0026", "Henok Ayele", 2.9m, true),
    ("STU-0027", "Martha Zewdu", 3.7m, true),
    ("STU-0028", "Yonas Berhanu", 3.1m, false),
    ("STU-0029", "Ruth Melaku", 3.9m, true),
    ("STU-0030", "Amanuel Sisay", 2.7m, true),
    ("STU-0031", "Betelhem Alemayehu", 3.6m, true),
    ("STU-0032", "Getachew Mamo", 2.8m, false),
    ("STU-0033", "Frehiwot Shiferaw", 3.9m, true),
    ("STU-0034", "Abenezer Tsegaye", 3.0m, true),
    ("STU-0035", "Alemitu Gebre", 2.6m, true),
    ("STU-0036", "Tewodros Belay", 3.4m, false),
    ("STU-0037", "Hanna Fantahun", 3.8m, true),
    ("STU-0038", "Girum Endale", 2.9m, true),
    ("STU-0039", "Mahlet Kassahun", 3.5m, true),
    ("STU-0040", "Solomon Aklilu", 3.1m, false),
